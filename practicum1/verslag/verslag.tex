...
\lstinputlisting[language=Matlab, caption=Opdracht 9, firstline=45, lastline=56]{../opdrachten.m}

\section*{Opdracht 14}

\lstinputlisting[language=Matlab, caption=Opdracht 12]{../r0381767_cluster.m}
